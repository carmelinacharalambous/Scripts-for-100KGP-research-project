...
# Select 12,449 GEL samples for PCA
...
# Start message
echo "Select 12,449 GEL samples for PCA"
date
echo ""
...
scripts_folder="${base_folder}/scripts/S13_add_eigenvectors/s02_select_gel_samples"

source_data_folder="${base_folder}/data/S13_add_eigenvectors/s01_copy_source_data"
source_vcf="${source_data_folder}/all_gel_100kv_b38_genotypes.vcf.gz"
samples_file="${source_data_folder}/intersect_labkey_VCF_samples.txt"

output_data_folder="${base_folder}/data/S13_add_eigenvectors/s02_select_gel_samples"
