...
cases_groups <- c("RENAL_CLEAR_CELL")
controls_groups <- c("RD_control")

genders <- c("Female", "Male")

analysis_name <-"Renal clear cell carcinoma"
working_folder <- "S38_renal_cell" 
```
